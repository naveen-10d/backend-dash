...
module.exports.resetpassword = function (UserDetails, callback) {
    UserDao.resetpassword(UserDetails, function (response) {
        callback(response);
    })
}
...
module.exports.ForgotPassword = (mail, callback) => {
    console.log('entering into ForgotPassword mail service', mail);
    UserDao.ForgotPassword(mail,function(response){
        callback(response);
    });
}

module.exports.UpdatePassword = (token, callback) => {
    console.log('entering into ForgotPassword mail service', token);
    UserDao.UpdatePassword(token,function(response){
        callback(response);
    });
}
