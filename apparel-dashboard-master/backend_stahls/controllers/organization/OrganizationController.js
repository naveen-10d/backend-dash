...
module.exports.creeateOrganization = function (req, res) {
    ...
    OrganizationService.createOrganization(OrganizationDetails, function (response, status) {
        res.json(response);
        res.status(status);
    })
}
...
module.exports.getallOrganization = function (req, res) {
    OrganizationService.getallOrganization(function (response, status) {
        res.json(response);
        res.status(status);
    })
}
...
module.exports.getOrganizationById = function (req, res) {
    ...
    OrganizationService.getOrganizationById(Organisation_id, function (response, status) {
        res.json(response);
        res.status(status);
    })
}
...
module.exports.delete_Organisation = function (req, res) {
    var Organisation_id = req.params.uuid;
    OrganizationService.delete_Organisation(Organisation_id, function (response, status) {
        res.status(status);
        res.end();
    });
}
...
module.exports.update_Organisation = function (req, res) {
    var OrganizationDetails = req.body;
    OrganizationService.update_Organisation(OrganizationDetails, function (response, status) {
        res.json(response);
        res.status(status);
    });
}