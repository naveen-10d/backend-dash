...
import {TicketDashboardPage} from  '../tickets/ticketdashboard/ticketdashboard';
...
export class SideMenuContentComponent {
	...
	DashboardPageComponent(){
		console.log("i am in route area")
		this.navCtrl.push(DashboardPage);
	}

	TicketComponentPage() {
		console.log("i am in route ticket")
		this.navCtrl.push(TicketDashboardPage);
	}

	PurchaseOrderComponentPage() {
		this.navCtrl.push(PurchaseOrdersComponent)
	}
	ngOnDestroy() {
